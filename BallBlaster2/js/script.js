...
const srcSoundBonus = "../sounds/bonus.mp3"
const srcSoundEnd = "../sounds/end.mp3"
const srcSoundBigBoom = "../sounds/bigBoom.mp3"
...
const createEffet = () => {
    ...
    blastRings(W/2, H/2, progress - 120, 40, "aqua");
...
const eventsListener = () => {
    ...
    checkbowaudio.addEventListener("click", function(){
        ...
        if(!checkBoxAudio){
            checkbowaudio.innerHTML = `<i class="bi-volume-mute"></i>`
        }
        else{
            checkbowaudio.innerHTML = `<i class="bi-volume-up"></i>`
        }
    });
    play_pause.addEventListener("click", function(){
        pause = pause ? false: true
        if(pause){
            play_pause.innerHTML = `<i class="bi-play"></i>`
            c.style.webkitFilter = "blur(30px)";
        }
        else{
            play_pause.innerHTML = `<i class="bi-pause"></i>`
